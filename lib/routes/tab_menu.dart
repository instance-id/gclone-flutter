...
class _TabMenuState extends State<TabMenu> with TickerProviderStateMixin {
  ...
  NavPages currentSelected = NavPages.Remotes;
        ...
        children: <Widget>[
          Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                TabItem(
                    selected: currentSelected == NavPages.Remotes,
                    iconData: Icons.home,
                    title: "REMOTES",
                    callbackFunction: () {
                      setState(() {
                        ...
                        navigation.updateNavigation(NavPages.Remotes);
                      });
                      _initAnimationAndStart(_positionAnimation.value, -1);
                    }),
                TabItem(
                    selected: currentSelected == NavPages.ScheduledJobs,
                    ...
                    callbackFunction: () {
                      setState(() {
                        ...
                        Navigator.of(context).pop();
                        navigation.updateNavigation(NavPages.ScheduledJobs);
                      });
                      _initAnimationAndStart(_positionAnimation.value, 0);
                    }),
                TabItem(
                    selected: currentSelected == NavPages.JobStatus,
                    ...
                    callbackFunction: () {
                      setState(() {
                        ...
                        Navigator.of(context).pop();
                        navigation.updateNavigation(NavPages.JobStatus);
                      });
                      _initAnimationAndStart(_positionAnimation.value, 1);
                    })
              ],
